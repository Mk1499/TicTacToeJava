                ...
                try {
                   ...
                   while(true){
                        try {
                              ...
                              oppPlayX = Integer.parseInt(dis.readLine()) ;
                              oppPlayY = Integer.parseInt(dis.readLine())  ;
                             ...
                             for (int j = 0; j < 3; j++) {
                                 if (board[i][j] == this){
                                     ...
                                     if (myId%2!=0) // if my id odd 
                                       ps.println(myId+1); // send opponent id (myId+1) 
                                     else if (myId%2==0)
                                       ps.println(myId-1);
                                     
                                     System.out.println("To ID Sent");
                                     ps.println(j); // send clicked tile row
                                     ps.println(i); // send clicked tile col
                                 }
